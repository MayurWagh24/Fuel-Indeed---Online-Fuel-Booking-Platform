...
<title>View Assigned Bookings</title>
...
<center>
    <%
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("select * from bookings where status=? and deliveryPersonId=?");
    ...
    <table>
        ...
        <tr>
            ...
            <td><a href="3_EnterDeliveryCode.html" style="color: #00d9ff; text-decoration: none;">Delivered</a></td>
        </tr>
        <%
            }
        } catch (Exception e) {
...
<a href="3_DeliveryPersonDashboard.html" class="dashboard-link">Go to Dashboard</a>
